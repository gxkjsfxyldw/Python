...
class Testdata():
    ...
    def test_operation_input(self):#操作网页的输入UI
        ...
        self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div/div[1]/div[1]/div[1]/div[1]/div/div[2]/details').click()#点击下拉分类
        self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div/div[1]/div[1]/div[1]/div[1]/div/div[2]/details/div/ul/li[17]').click()#点击选择分类

        self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div/div[1]/div[1]/div[1]/div[1]/div/details/summary').click()#点击下拉标签
        self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div/div[1]/div[1]/div[1]/div[1]/div/details/div/ul/li[4]').click()#点击选择下拉标签

        self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div[2]/div/div/div[1]/div[2]/textarea').send_keys("what's?")
        sleep(3)
        #self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div[3]/div/button').click() #点击创建话题
        self.driver.find_element_by_xpath('//*[@id="reply-control"]/div[3]/div[3]/div/a').click() #点击取消创建话题
        self.driver.find_element_by_xpath('//*[@class="modal-inner-container"]/div[4]/button[1]').click() #点击弹窗舍弃话题
